...
<ul>
 ...
 <ul>
 <li><b> Монолитная сборка (Static Backends): Выполнен отказ от внешней системы драйверов (.so). Поддержка протоколов QMI, AT и HTTP (CURL) теперь жестко вкомпилирована в основной бинарный файл lpac. ВНИМАНИЕ: MBIM пока что в билде отсутствует!</li>
